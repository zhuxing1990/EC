...
import com.vunke.ec.adapter.GAPAdapter;
 ...
 * 政务公开
 */
public class GovernmentAffairsPublicityActivity extends BaseActivity {
    private static final String TAG = "PartyAffairsPublicityActivity";
    private String infoId;
    private TvRecyclerView gap_content_recycler;
//    private List<Map<String, Object>> datalist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_government_affairs_publicity);
        initView();
        getIntentData();
//        initData();
    }
    ...
    private void initView() {
        gap_title = (TextView) findViewById(R.id.gap_title);
        gap_content_recycler = (TvRecyclerView) findViewById(R.id.gap_content_recycler);
        LinearLayoutManager manager = new LinearLayoutManager(this);
        manager.setOrientation(LinearLayoutManager.VERTICAL);
        gap_content_recycler.setLayoutManager(manager);

        gap_content_recycler.setOnItemStateListener(new TvRecyclerView.OnItemStateListener() {
            @Override
...
//                Configs.intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        gap_content_recycler.setSelectedScale(1.0f);
        gap_content_recycler.setSelectPadding(6, 6, 6, 6);
...
//                    WorkLog.i(TAG, "onAfter: " + columnBean.getCode().equals("200"));
                    if (columnBean != null && columnBean.getCode().equals("200")) {
                        gap_title.setText(columnBean.getBlockNmae());
                        initRecyclerView();
                    }
                }
            });
    ...
    private void initRecyclerView() {
        ...
        if (dataBean != null) {
            ...
            GAPAdapter adapter = new GAPAdapter(mcontext, dataBean);
            gap_content_recycler.setAdapter(adapter);
                ...
                Observable.timer(500, TimeUnit.MILLISECONDS)
                        ...
                        .subscribe(new Action1<Long>() {
                            ...
                            public void call(Long aLong) {
                                gap_content_recycler.setItemSelected(0);
                            }
                        });
            }
        }
